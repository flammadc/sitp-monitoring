...
const DataAdmin = () => {
  ...
  return (
    <div className="grid grid-cols-12 pr-10 pt-10">
      <div className="col-span-12 grid grid-cols-12 bg-white ml-16 pr-5 pl-6 pb-8 pt-7 shadow-md">
        <div className="mb-7 col-span-12 flex flex-row  items-center">
